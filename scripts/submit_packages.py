...
class PackageSubmitter:
    ...
    def submit_windows_store(self):
        ...
        subprocess.run([
            ...
            "--clean",
            "--onefile",
            "--name", f"plainspeak-{self.version}",
            "--icon", "assets/icons/windows/plainspeak.ico",
    ...
    def submit_mac_app_store(self):
        ...
        subprocess.run([
            ...
            "--windowed",
            "--name", "PlainSpeak",
            "--icon", "assets/icons/macos/plainspeak.icns",
            "--osx-bundle-identifier", "org.plainspeak.app",
            "plainspeak/__main__.py"
        ], check=True)
...
def main():
    ...
    parser.add_argument("--skip-test", action="store_true",
                      help="Skip Test PyPI submission")
