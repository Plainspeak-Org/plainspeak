...
class TestEndToEnd(unittest.TestCase):
    ...
    def test_unknown_command(self):
        ...
        self.mock_llm.parse_natural_language.return_value = {"verb": "unknown", "args": {}}
    ...
    def test_command_execution_error(self):
        ...
        self.mock_executor.execute.return_value = (False, "Command not found: invalid_command")
...
class TestREPLEndToEnd(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_session.execute_natural_language.return_value = (True, "Command executed successfully")
    ...
    def configure_mock_llm(self):
        ...
        def mock_parse_side_effect(text):
            ...
            if "list" in words or "show" in words:
                ...
                return {"verb": "copy", "args": {"source": "test.txt", "destination": "backup.txt"}}
