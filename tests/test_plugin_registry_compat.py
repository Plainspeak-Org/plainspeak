"""
Tests for the plugin registry with compatibility fixes.

This module provides compatibility for tests that were written for the old plugin registry structure.
"""
...
class PluginFixture(Plugin):
    ...
    def __init__(self, name="test", description="Test plugin", verbs=None, aliases=None):
