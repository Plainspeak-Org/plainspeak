...
class TestCommandPipeline(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_executor.execute.return_value = (True, "Command executed successfully")
    ...
    def setup_mock_llm(self):
        ...
        self.llm_responses = {
            ...
            "find all txt files": {"verb": "find", "args": {"path": ".", "pattern": "*.txt"}},
            "search for ERROR in log.txt": {"verb": "grep", "args": {"pattern": "ERROR", "file": "log.txt"}},
            "show processes": {"verb": "ps", "args": {}},
            "ping google.com": {"verb": "ping", "args": {"host": "google.com"}},
            "create a file called newfile.txt": {"verb": "create", "args": {"file": "newfile.txt"}},
            "copy test.txt to backup.txt": {"verb": "copy", "args": {"source": "test.txt", "destination": "backup.txt"}},
            "move test.txt to archive/": {"verb": "move", "args": {"source": "test.txt", "destination": "archive/"}},
            "delete backup.txt": {"verb": "delete", "args": {"file": "backup.txt"}},
            "download https://example.com/file.txt": {"verb": "wget", "args": {"url": "https://example.com/file.txt"}},
    ...
    def test_command_failure(self):
        ...
        self.mock_executor.execute.side_effect = lambda cmd: (False, f"Error: {cmd} failed")
    ...
    def test_unknown_verb(self):
        ...
        self.mock_llm.parse_natural_language.return_value = {"verb": "unknown_verb", "args": {}}
...
class TestLearningSystem(unittest.TestCase):
    ...
    def test_feedback_storage(self):
        ...
        self.mock_llm.parse_natural_language.return_value = {"verb": "ls", "args": {"path": "."}}
    ...
    def test_learning_from_feedback(self):
        ...
        self.mock_llm.get_improved_command.assert_called_with(
            query, 
            any,  # feedback data
...
class TestPluginIntegration(unittest.TestCase):
    ...
    def test_all_plugins_generate_commands(self):
        ...
        test_cases = [
            ...
            ("copy", {"source": "file1.txt", "destination": "file2.txt"}, self.file_plugin),
            ("move", {"source": "file1.txt", "destination": "file2.txt"}, self.file_plugin),
            ...
            ("sed", {"pattern": "old", "replacement": "new", "file": "text.txt"}, self.text_plugin),
    ...
    def test_plugin_manager_command_generation(self):
        ...
        test_verbs = [
            "ls", "find", "copy", "move", "delete", "create", "zip", "unzip",  # File plugin
            "grep", "sed", "sort", "wc", "head", "tail",  # Text plugin
            "ps", "top", "df", "du", "free",  # System plugin
            "ping", "wget", "curl", "nslookup"  # Network plugin
        ]
        
        for verb in test_verbs:
            # Simple test arguments
            args = {"path": ".", "file": "test.txt", "host": "localhost", "url": "https://example.com"}
            
            # Test command generation
            success, command = self.plugin_manager.generate_command(verb, args)
            self.assertTrue(
                success,
                f"Plugin manager should generate command for verb '{verb}'"
            )
            self.assertIsInstance(
                command, 
                str,
