...
from plainspeak.core.i18n import I18n, get_locale, set_locale, available_locales
...
class TestI18nClass(unittest.TestCase):
    ...
    def test_format_with_params(self):
        ...
        self.i18n.set_locale("en_US")
        self.assertEqual(
            self.i18n.t("error", {"message": "File not found"}),
    ...
    def test_pluralization(self):
        ...
        # Multiple files
        self.assertEqual(
            self.i18n.t("count_files", {"count": 5}),
            "5 files found"
        )
...
class TestI18nIntegration(unittest.TestCase):
    ...
    def test_i18n_with_llm(self):
        ...
        # Set up mock LLM
        self.mock_llm.parse_natural_language_with_locale.return_value = {"verb": "ls", "args": {"path": "."}}
