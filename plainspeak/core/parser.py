...
class NaturalLanguageParser:
    ...
    def get_examples(self, locale: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        fallback_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "examples", "en_US.json")
        ...
        return [
            {"input": "list files", "output": {"verb": "ls", "args": {"path": "."}}},
            {
                "input": "find all text files",
                "output": {"verb": "find", "args": {"path": ".", "pattern": "*.txt"}},
            },
            {"input": "show running processes", "output": {"verb": "ps", "args": {}}},
        ]
